...
public class AirMapInterface extends JPanel implements ActionListener {
 ...
 public void actionPerformed(ActionEvent e){
  ...
  public static void TravelMap(){
      ...
      funMap.setPreferredSize(new Dimension(500, 500));
      
      frame.getContentPane().add(buttonPanel, BorderLayout.EAST); // put the button panel on the right
      frame.getContentPane().add(funMap, BorderLayout.WEST); // put the map panel on the left
  }
